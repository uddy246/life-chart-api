...
def test_profile_timeline_intersection_time_schema_valid():
    params = {
        "name": "Example Person",
        "date": "1999-02-26",
        "time": "14:00:00",
    ...
    intersection_cycles = [
        cycle for cycle in response_json.get("cycles", []) if cycle.get("system") == "intersection"
    ]
    assert intersection_cycles
